    ...
    <Center py={6}>
      ...
      >
        ...
        <Text fontWeight={600} color={"gray.500"} ml={4} mb={4} mt={3}>
          Hm sorry but you didn’t pass the test, let’s try again ..
        </Text>
        <Image
          mt={12}
          boxSize="210px"
          src={"https://www.linkpicture.com/q/3d-fluency-vlc-logo.png"}
          alt={"Image Alt"}
          mb={4}
          ml={60}
        />
        ...
        <Stack direction={"row"} justify={"center"} spacing={6}>
          <Stack spacing={0} align={"center"} ml={5} mt={6} mb={4}>
            <Heading color={"green.500"}>1 Benar</Heading>
          </Stack>
          <Stack direction={"row"} justify={"center"} spacing={6}>
            <Stack spacing={0} align={"center"} ml={4} mt={6} mb={4}>
              <Heading color={"red.500"}>4 Salah</Heading>
            </Stack>
          </Stack>
        </Stack>
